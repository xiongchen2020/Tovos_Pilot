package com.tovos.uav.sample.playload;
...
import com.example.djilib.dji.util.GeneralUtils;
...
public class PayloadSendGetDataActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private KeyListener getDataListener = new KeyListener() {
        ...
        public void onValueChange(@Nullable Object oldValue, @Nullable final Object newValue) {
            ...
            ToastUtils.setResultToToast(""+newValue);
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        if (newValue instanceof byte[]) {
                            ...
                            LogUtil.e(TAG, "receiving data size:" + data.length);
    ...
    private void initListener() {
        ...
        if (KeyManager.getInstance() != null) {
            ToastUtils.setResultToToast("KeyManager 初始化");
            ...
            ToastUtils.setResultToToast("KeyManager 没有初始化");
        }
    ...
    private void sendData() {
        ...
        LogUtil.e(TAG, "sending:" + sendingDataStr);
